...
// ==========================================
// 1. MAIN BOOST PANEL (HOME SCREEN)
// ==========================================
...
class _PremiumBoostPanelState extends State<PremiumBoostPanel> with TickerProviderStateMixin {
      ...
      body: Container(
        decoration: const BoxDecoration(
            image: DecorationImage(
                image: NetworkImage("https://i.imgur.com/LoadH9S.png"), opacity: 0.05, fit: BoxFit.cover)),
  ...
  Widget _buildRamMonitorCard() {
    return Container(
      ...
      decoration: BoxDecoration(
        gradient: LinearGradient(begin: Alignment.topLeft, end: Alignment.bottomRight, colors: [const Color(0xFF1A221A), Colors.greenAccent.withOpacity(0.05)]),
        borderRadius: BorderRadius.circular(30),
        border: Border.all(color: Colors.greenAccent.withOpacity(0.3), width: 1),
        boxShadow: [BoxShadow(color: Colors.greenAccent.withOpacity(0.1), blurRadius: 20, offset: const Offset(0, 5))],
      ),
      child: Column(
        children: [
          Stack(
          ...
          AnimatedContainer(
            ...
            decoration: BoxDecoration(
              ...
              boxShadow: _isBoosting ? [] : [BoxShadow(color: Colors.greenAccent.withOpacity(0.4), blurRadius: 12, offset: const Offset(0, 4))]
            ),
            child: Material(
